...
public static class ConcurrencyHelper
{
    ...
    public static async IAsyncEnumerable<TMessage> WhenAll<T, TMessage>(this IEnumerable<T> tasks,
        OnPublicationDelegate<T, TMessage> onPublication,
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        var channel = Channel.CreateBounded<TMessage>(new BoundedChannelOptions(512)
        {
